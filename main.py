...
import models
from routers import auth_router, cameras_router, persons_router, logs_router, ws_router, categories_router, fields_router, reports_router, telegram_router, rtsp_router
...
app.include_router(rtsp_router.router, prefix="/ws", tags=["RTSP"])
